...
describe('brita module', function(){
  ...
  describe('when passing an object as the filter argument', function(){
    ...
    describe('a filter object with key value pair valueType: array', function(){
      it('should return an object containing only array values', function(){
        //arrange
        var testObj = {
          one:   1,
          two:   true,
    ...
    describe('a filter object with key value pair valueType: regex', function(){
      it('should return an object containing only regex values', function(){
        //arrange
        var testObj = {
          one:   1,
          two:   true,
